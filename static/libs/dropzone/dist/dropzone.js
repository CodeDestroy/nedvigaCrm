let $6mU8w$swchelpers = require("@swc/helpers"), $6mU8w$justextend = require("just-extend");
...
let $b1d17cfb1d15c36a$export$2e2bcd8739ae039 = /*#__PURE__*/ function () {
    "use strict";
    ...
    $6mU8w$swchelpers.createClass($b1d17cfb1d15c36a$export$2e2bcd8739ae039, [{
        ...
        value: function emit(event) {
            ...
            this._callbacks = this._callbacks || {};
            let callbacks = this._callbacks[event], _iteratorNormalCompletion = true,
                _didIteratorError = false, _iteratorError = undefined;
            if (callbacks) try {
                for (let _iterator = callbacks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        value: function makeEvent(eventName, detail) {
            ...
            if (typeof window.CustomEvent === "function") return new CustomEvent(eventName, params);
                ...
                // IE 11 support https://developer.mozilla.org/en-US/docs/Web/API/CustomEvent/CustomEvent
        ...
        // Remove event listener for given event. If fn is not provided, all event listeners for that event will be
        // removed. If neither is provided, all event listeners will be removed.
        key: "off",
...
let $b657c03155fc27e2$var$defaultOptions = {
     ...
     * have the `multiple` attribute as well. This option will also trigger additional events (like `processingmultiple`).
     ...
     */ chunking: false,
    /**
     * If `chunking` is enabled, this defines whether **every** file should be chunked, even if the file size is below
     * chunkSize. This means, that the additional chunk form data will be submitted and the `chunksUploaded` callback will be invoked.
     */ forceChunking: false,
    /**
     ...
     */ fallback: function () {
        ...
        let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
        try {
            for (let _iterator = this.element.getElementsByTagName("div")[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
     ...
     */ resize: function (file, width, height, resizeMethod) {
        let info = {srcX: 0, srcY: 0, srcWidth: file.width, srcHeight: file.height};
    ...
    /**
     * A string that contains the template used for each dropped file. Change it to fulfill your needs but make sure to
     * properly provide all elements.
     *
     * If you want to use an actual HTML element instead of providing a String as a config option, you could create a
     * div with the id `tpl`, put the template inside it and provide the element like this:
   ...
   */ // Those are self explanatory and simply concern the DragnDrop.
    ...
    // Called whenever there are no files left in the dropzone anymore, and the dropzone should be displayed as if in the initial state.
    reset: function () {
    ...
    addedfile: function (file) {
        ...
        if (this.previewsContainer && !this.options.disablePreviews) {
            ...
            let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
            try {
                for (let _iterator = file.previewElement.querySelectorAll("[data-dz-name]")[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            let _iteratorNormalCompletion1 = true, _didIteratorError1 = false, _iteratorError1 = undefined;
            try {
                for (let _iterator1 = file.previewElement.querySelectorAll("[data-dz-size]")[Symbol.iterator](), _step1; !(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done); _iteratorNormalCompletion1 = true) {
                    node = _step1.value;
            ...
            let removeFileEvent = function (e) {
                let _this1 = _this;
                e.preventDefault();
                e.stopPropagation();
            ...
            let _iteratorNormalCompletion2 = true, _didIteratorError2 = false, _iteratorError2 = undefined;
            try {
                for (let _iterator2 = file.previewElement.querySelectorAll("[data-dz-remove]")[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    let removeLink = _step2.value;
    ...
    thumbnail: function (file, dataUrl) {
        if (file.previewElement) {
            ...
            let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
            try {
                for (let _iterator = file.previewElement.querySelectorAll("[data-dz-thumbnail]")[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    let thumbnailElement = _step.value;
    ...
    error: function (file, message) {
        if (file.previewElement) {
            ...
            let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
            try {
                for (let _iterator = file.previewElement.querySelectorAll("[data-dz-errormessage]")[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    let node = _step.value;
    ...
    // Called when a file gets processed. Since there is a cue, not all added files are processed immediately. Receives `file`
    ...
    // Called whenever the upload progress gets updated. Receives `file`, `progress` (percentage 0-100) and `bytesSent`.
    // To get the total number of bytes of the file, use `file.size`
    uploadprogress: function (file, progress, bytesSent) {
        let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
        if (file.previewElement) try {
            for (let _iterator = file.previewElement.querySelectorAll("[data-dz-uploadprogress]")[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                let node = _step.value;
    ...
    // Called whenever the total upload progress gets updated. Called with totalUploadProgress (0-100), totalBytes and totalBytesSent
    totaluploadprogress: function () {},
    // Called just before the file is sent. Gets the `xhr` object as second parameter, so you can modify it (for example
    // to add a CSRF token) and a `formData` object to add additional information.
    sending: function () {},
...
let $b657c03155fc27e2$export$2e2bcd8739ae039 = $b657c03155fc27e2$var$defaultOptions;
let $a601ff30f483e917$export$2e2bcd8739ae039 = /*#__PURE__*/ function (Emitter) {
    "use strict";
    ...
    function $a601ff30f483e917$export$2e2bcd8739ae039(el, options) {
        ...
        let elementOptions = (left = $a601ff30f483e917$export$2e2bcd8739ae039.optionsForElement(_this.element)) != null ? left : {};
    ...
    $6mU8w$swchelpers.createClass($a601ff30f483e917$export$2e2bcd8739ae039, [{
        ...
        key: "init",
        value: function init() {
            let _this12 = this, _this1 = this, _this2 = this, _this3 = this, _this4 = this, _this5 = this,
            ...
            if (this.clickableElements.length) {
                let _this = this, setupHiddenFileInput = function () {
                    let _this11 = _this;
                    ...
                    // Not setting `display="none"` because some browsers don't accept clicks on elements that aren't displayed.
                    ...
                    _this.hiddenFileInput.addEventListener("change", function () {
                        let _hiddenFileInput = _this11.hiddenFileInput, files = _hiddenFileInput.files;
                        let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
                        if (files.length) try {
                            for (let _iterator = files[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            try {
                ...
                for (let _iterator = this.events[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    let eventName = _step.value;
            ...
            this.on("uploadprogress", () => { return _this12.updateTotalUploadProgress(); });
            this.on("removedfile", () => { return _this1.updateTotalUploadProgress(); });
            this.on("canceled", (file) => { return _this2.emit("complete", file); });
            ...
            let containsFiles = function containsFiles(e) {
            ...
            let noPropagation = function noPropagation(e) {
                // If there are no files, we don't want to stop propagation so we don't interfere with other drag and drop behaviour.
            ...
            this.listeners = [{
                ...
                events: {
                    dragstart: (e) => { return _this4.emit("dragstart", e); },
                    dragenter: function (e) {
                        noPropagation(e);
                    ...
                    dragleave: (e) => { return _this7.emit("dragleave", e); },
                    drop: function (e) {
                        noPropagation(e);
                        return _this8.drop(e);
                    },
                    dragend: (e) => { return _this9.emit("dragend", e); }
                }
            }];
        ...
        value: function updateTotalUploadProgress() {
            let totalUploadProgress, totalBytesSent = 0, totalBytes = 0, activeFiles = this.getActiveFiles();
            if (activeFiles.length) {
                let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
                try {
                    for (let _iterator = this.getActiveFiles()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        let file = _step.value;
        ...
        value: function getFallbackForm() {
            ...
            let fields = $a601ff30f483e917$export$2e2bcd8739ae039.createElement(fieldsString);
        ...
        value: function getExistingFallback() {
            let getFallback = function getFallback(elements) {
                let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
                try {
                    for (let _iterator = elements[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        let el = _step.value;
            ...
            let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
            try {
                for (let _iterator = ["div", "form"][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    let tagName = _step.value, fallback;
        ...
        value: function disable() {
            let _this = this;
            this.clickableElements.forEach((element) => { return element.classList.remove("dz-clickable"); });
            this.removeEventListeners();
            this.disabled = true;
            return this.files.map((file) => { return _this.cancelUpload(file); });
        }
    }, {
        key: "enable",
        value: function enable() {
            delete this.disabled;
            this.clickableElements.forEach((element) => { return element.classList.add("dz-clickable"); });
        ...
        value: function filesize(size) {
            let selectedSize = 0, selectedUnit = "b";
            if (size > 0) {
                let units = ["tb", "gb", "mb", "kb", "b"];
                for (let i = 0; i < units.length; i++) {
                    let unit = units[i], cutoff = Math.pow(this.options.filesizeBase, 4 - i) / 10;
                    if (size >= cutoff) {
        ...
        value: function drop(e) {
            ...
            if (files.length) {
                let _dataTransfer = e.dataTransfer, items = _dataTransfer.items;
        ...
        value: function paste(e) {
            if ($a601ff30f483e917$var$__guard__(e != null ? e.clipboardData : undefined, (x) => { return x.items; }) == null) return;
            this.emit("paste", e);
            let _clipboardData = e.clipboardData, items = _clipboardData.items;
        ...
        value: function _addFilesFromItems(items) {
            let _this = this;
            return (function () {
                let result = [], _iteratorNormalCompletion = true, _didIteratorError = false,
                    _iteratorError = undefined;
                try {
                    for (let _iterator = items[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        let item = _step.value, entry;
        ...
        value: function _addFilesFromDirectory(directory, path) {
            let _this = this, dirReader = directory.createReader();
            let errorHandler = function (error) {
                return $a601ff30f483e917$var$__guardMethod__(console, "log", (o) => { return o.log(error); });
            };
            let readEntries = function () {
                ...
                return dirReader.readEntries(function (entries) {
                    if (entries.length > 0) {
                        let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
                        try {
                            for (let _iterator = entries[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                                let entry = _step.value, _this2 = _this1;
        ...
        // If you call it with an error message, the file is rejected (This allows for asynchronous validation)
        ...
        value: function enqueueFile(file) {
            if (file.status === $a601ff30f483e917$export$2e2bcd8739ae039.ADDED && file.accepted === true) {
                ...
                if (this.options.autoProcessQueue) return setTimeout(() => { return _this.processQueue(); }, 0); // Deferring the call
        ...
        value: function _enqueueThumbnail(file) {
            if (this.options.createImageThumbnails && file.type.match(/image.*/) && file.size <= this.options.maxThumbnailFilesize * 1048576) {
                ...
                return setTimeout(() => { return _this._processThumbnailQueue(); }, 0); // Deferring the call
            }
        }
    }, {
        ...
        value: function removeAllFiles(cancelIfNecessary) {
            ...
            let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
            try {
                for (let _iterator = this.files.slice()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    let file = _step.value;
        ...
        // `options.transformFile` if `resizeWidth` or `resizeHeight` are set. The callback is invoked with the resized blob.
        key: "resizeImage",
        value: function resizeImage(file, width, height, resizeMethod, callback) {
            ...
            return this.createThumbnail(file, width, height, resizeMethod, true, function (dataUrl, canvas) {
                if (canvas == null) return callback(file);
                    ...
                    let _options = _this.options, resizeMimeType = _options.resizeMimeType;
                    if (resizeMimeType == null) resizeMimeType = file.type;
                    let resizedDataURL = canvas.toDataURL(resizeMimeType, _this.options.resizeQuality);
        ...
        value: function createThumbnail(file, width, height, resizeMethod, fixOrientation, callback) {
            let _this = this, fileReader = new FileReader();
        ...
        value: function displayExistingFile(mockFile, imageUrl, callback, crossOrigin, param) {
            let resizeThumbnail = param === void 0 ? true : param;
        ...
        value: function createThumbnailFromUrl(file, width, height, resizeMethod, fixOrientation, callback, crossOrigin) {
            let _this = this;
            // Not using `new Image` here because of a bug in latest Chrome versions. See https://github.com/enyo/dropzone/pull/226
            let img = document.createElement("img");
            if (crossOrigin) img.crossOrigin = crossOrigin;
            // fixOrientation is not needed anymore with browsers handling imageOrientation
            fixOrientation = getComputedStyle(document.body)["imageOrientation"] === "from-image" ? false : fixOrientation;
            img.onload = function () {
                let _this1 = _this, loadExif = (callback) => { return callback(1); };
                if (typeof EXIF !== "undefined" && EXIF !== null && fixOrientation) loadExif = function (callback) {
                    return EXIF.getData(img, () => { return callback(EXIF.getTag(this, "Orientation")); });
                };
                return loadExif(function (orientation) {
                    file.width = img.width;
                    file.height = img.height;
                    let resizeInfo = _this1.options.resize.call(_this1, file, width, height, resizeMethod);
        ...
        value: function processQueue() {
            let _options = this.options, parallelUploads = _options.parallelUploads;
            let processingLength = this.getUploadingFiles().length, i = processingLength;
        ...
        // Cancels the file upload and sets the status to CANCELED **if** the file is actually being uploaded.
        // If it's still in the queue, the file is being removed from it and the status set to CANCELED.
        key: "cancelUpload",
        value: function cancelUpload(file) {
            if (file.status === $a601ff30f483e917$export$2e2bcd8739ae039.UPLOADING) {
                ...
                let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
                try {
                    for (let _iterator = groupedFiles[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        let groupedFile = _step.value;
                ...
                let _iteratorNormalCompletion1 = true, _didIteratorError1 = false, _iteratorError1 = undefined;
                try {
                    for (let _iterator1 = groupedFiles[Symbol.iterator](), _step1; !(_iteratorNormalCompletion1 = (_step1 = _iterator1.next()).done); _iteratorNormalCompletion1 = true) {
                        let groupedFile = _step1.value;
        ...
        value: function uploadFiles(files) {
            ...
            this._transformFiles(files, function (transformedFiles) {
                if (_this.options.chunking) {
                    // Chunking is not allowed to be used with `uploadMultiple` so we know that there is only __one__file.
                ...
                if (files[0].upload.chunked) {
                    let _this1 = _this, _this4 = _this;
                    // This file should be sent in chunks!
                    // If the chunking option is set, we **know** that there can only be **one** file, since
                    // uploadMultiple is not allowed with this option.
                    let file = files[0], transformedFile = transformedFiles[0], startedChunkCount = 0;
                    file.upload.chunks = [];
                    let handleNextChunk = function () {
                        let chunkIndex = 0;
                        ...
                        startedChunkCount++;
                        let start = chunkIndex * _this1.options.chunkSize;
                        let end = Math.min(start + _this1.options.chunkSize, transformedFile.size);
                        let dataBlock = {
                    ...
                    file.upload.finishedChunkUpload = function (chunk, response) {
                        let _this5 = _this4, allFinished = true;
                        ...
                        if (allFinished) _this4.options.chunksUploaded(file, () => { _this5._finished(files, response, null); });
                    };
                    if (_this.options.parallelChunkUploads) for (let i = 0; i < file.upload.totalChunkCount; i++) handleNextChunk();
        ...
        // This function actually uploads the file(s) to the server. If dataBlocks contains the actual data to upload
        // (meaning, that this could either be transformed files, or individual chunks for chunked upload) then
        // they will be used for the actual data to upload.
        key: "_uploadData",
        value: function _uploadData(files, dataBlocks) {
            let _this = this, _this7 = this, _this8 = this, _this9 = this, xhr = new XMLHttpRequest();
            let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
            try {
            ...
            xhr.onload = (e) => { _this._finishedUploading(files, xhr, e); };
            xhr.ontimeout = () => { _this7._handleUploadError(files, xhr, "Request timedout after ".concat(_this7.options.timeout / 1000, " seconds")); };
            xhr.onerror = () => { _this8._handleUploadError(files, xhr); };
            // Some browsers do not have the .upload property
            let progressObj = xhr.upload != null ? xhr.upload : xhr;
            progressObj.onprogress = (e) => { return _this9._updateFilesUploadProgress(files, xhr, e); };
            let headers = this.options.defaultHeaders ? {Accept: "application/json", "Cache-Control": "no-cache", "X-Requested-With": "XMLHttpRequest"} : {};
            ...
            if (this.options.binaryBody) {
                ...
                if (this.options.params) {
                    ...
                    for (let key in additionalParams) {
                        ...
                        if (Array.isArray(value)) // The additional parameter contains an array, so lets iterate over it to attach each value individually.
        ...
        value: function _transformFiles(files, done) {
            let _this = this, _loop = function (i) {
            ...
            let doneCounter = 0;
            for (let i = 0; i < files.length; i++) _loop(i);
        }
    }, {
        ...
        value: function _addFormElementData(formData) {
            ...
            if (this.element.tagName === "FORM") try {
                for (let _iterator = this.element.querySelectorAll("input, textarea, select, button")[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    let input = _step.value, inputName = input.getAttribute("name");
                    ...
                    if (input.tagName === "SELECT" && input.hasAttribute("multiple")) {
                        ...
                        try {
                            ...
                            for (let _iterator = input.options[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        value: function initClass() {
             ...
             * You can register an event handler like this: dropzone.on("dragEnter", function() { });
             */
...
//
// Example: Dropzone.options.myDropzoneElementId = { maxFilesize: 1 };
//
// And in html:
//
...
$a601ff30f483e917$export$2e2bcd8739ae039.discover = function () {
    ...
    if (document.querySelectorAll) dropzones = document.querySelectorAll(".dropzone");
        ...
        dropzones = [];
        // IE :(
        let checkElements = function (elements) {
            return (function () {
                let result = [], _iteratorNormalCompletion = true, _didIteratorError = false,
                    _iteratorError = undefined;
                try {
    ...
    return (function () {
        let result = [], _iteratorNormalCompletion = true, _didIteratorError = false,
            _iteratorError = undefined;
        try {
            for (let _iterator = dropzones[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                let dropzone = _step.value;
...
//
// So I created a blocklist of userAgents. Yes, yes. Browser sniffing, I know. But what to do when browsers *theoretically*
// support an API, but crash when using it.
//
...
$a601ff30f483e917$export$2e2bcd8739ae039.isBrowserSupported = function () {
    if (window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector) {
        if (!("classList" in document.createElement("a"))) return false;
        else {
            ...
            try {
                ...
                for (let _iterator = $a601ff30f483e917$export$2e2bcd8739ae039.blockedBrowsers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    let regex = _step.value;
                    if (regex.test(navigator.userAgent)) return false;
                }
            } catch (err) {
                _didIteratorError = true;
                _iteratorError = err;
...
let $a601ff30f483e917$var$without = function (list, rejectedItem) {
...
let $a601ff30f483e917$var$camelize = function (str) {
...
$a601ff30f483e917$export$2e2bcd8739ae039.getElements = function (els, name) {
    ...
    if (els instanceof Array) {
        ...
        try {
            let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
            try {
                for (let _iterator = els[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    el = _step.value;
        ...
        let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
        try {
            for (let _iterator = document.querySelectorAll(els)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                el = _step.value;
                elements.push(el);
            }
        } catch (err) {
...
$a601ff30f483e917$export$2e2bcd8739ae039.isValidFile = function (file, acceptedFiles) {
    ...
    let mimeType = file.type, baseMimeType = mimeType.replace(/\/.*$/, "");
    let _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
    try {
        for (let _iterator = acceptedFiles[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            let validType = _step.value;
...
let $a601ff30f483e917$var$detectVerticalSquash = function $a601ff30f483e917$var$detectVerticalSquash(img) {
    let ih = img.naturalHeight, canvas = document.createElement("canvas");
    canvas.width = 1;
    canvas.height = ih;
    let ctx = canvas.getContext("2d");
    ctx.drawImage(img, 0, 0);
    let ref = ctx.getImageData(1, 0, 1, ih), data = ref.data;
...
let $a601ff30f483e917$var$drawImageIOSFix = function $a601ff30f483e917$var$drawImageIOSFix(ctx, img, sx, sy, sw, sh, dx, dy, dw, dh) {
    let vertSquashRatio = $a601ff30f483e917$var$detectVerticalSquash(img);
    return ctx.drawImage(img, sx, sy, sw, sh, dx, dy, dw, dh / vertSquashRatio);
};
let $a601ff30f483e917$var$ExifRestore = // Based on MinifyJpeg
...
// http://elicon.blog57.fc2.com/blog-entry-206.html
    ...
    $6mU8w$swchelpers.createClass($a601ff30f483e917$var$ExifRestore, null, [{
        ...
        value: function encode64(input) {
            let output = "", chr1 = undefined, chr2 = undefined, chr3 = "";
            let enc1 = undefined, enc2 = undefined, enc3 = undefined, enc4 = "", i = 0;
            while (true) {
                chr1 = input[i++];
                chr2 = input[i++];
                chr3 = input[i++];
        ...
        value: function restore(origFileBase64, resizedFileBase64) {
            ...
            let segments = this.slice2Segments(rawImage), image = this.exifManipulation(resizedFileBase64, segments);
            return "data:image/jpeg;base64,".concat(this.encode64(image));
        }
    }, {
        key: "exifManipulation",
        value: function exifManipulation(resizedFileBase64, segments) {
            let exifArray = this.getExifArray(segments), newImageArray = this.insertExif(resizedFileBase64, exifArray);
            return new Uint8Array(newImageArray);
        }
    }, {
        key: "getExifArray",
        value: function getExifArray(segments) {
            let seg = undefined, x = 0;
        ...
        value: function insertExif(resizedFileBase64, exifArray) {
            let imageData = resizedFileBase64.replace("data:image/jpeg;base64,", ""), buf = this.decode64(imageData);
            let separatePoint = buf.indexOf(255, 3), mae = buf.slice(0, separatePoint), ato = buf.slice(separatePoint);
            let array = mae;
        ...
        value: function slice2Segments(rawImageArray) {
            ...
            while (true) {
                ...
                if (rawImageArray[head] === 255 & rawImageArray[head + 1] === 216) head += 2;
                    ...
                    let endPoint = head + length + 2, seg = rawImageArray.slice(head, endPoint);
                    segments.push(seg);
                    head = endPoint;
                }
        ...
        value: function decode64(input) {
            let chr1 = undefined, chr2 = undefined, chr3 = "", enc1 = undefined;
            let enc2 = undefined, enc3 = undefined, enc4 = "", i = 0, buf = [];
...
let $a601ff30f483e917$var$contentLoaded = function $a601ff30f483e917$var$contentLoaded(win, fn) {
