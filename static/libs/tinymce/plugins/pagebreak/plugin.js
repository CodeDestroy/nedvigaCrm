...
(function () {
    ...
    const register$2 = editor => {
        ...
        registerOption('pagebreak_separator', {processor: 'string', default: '<!-- pagebreak -->'});
        registerOption('pagebreak_split_block', {processor: 'boolean', default: false});
    };
    const getSeparatorHtml = option('pagebreak_separator'), shouldSplitBlock = option('pagebreak_split_block');
    ...
    const setup$1 = editor => {
        const separatorHtml = getSeparatorHtml(editor), shouldSplitBlock$1 = () => shouldSplitBlock(editor);
    ...
    const register$1 = editor => { editor.addCommand('mcePageBreak', () => { editor.insertContent(getPlaceholderHtml(shouldSplitBlock(editor))); }); };
    const setup = editor => {
    ...
    const register = editor => {
        ...
        editor.ui.registry.addButton('pagebreak', {icon: 'page-break', tooltip: 'Page break', onAction});
        editor.ui.registry.addMenuItem('pagebreak', {text: 'Page break', icon: 'page-break', onAction});
    };
    let Plugin = () => {
